<template>
  <div>
    ...
    <p class="center" v-else-if="!categories.length">{{ $filters.localize('NoCategories') }}
      <router-link to="/categories">{{ $filters.localize('AddFirst') }}
      </router-link>
    </p>
      ...
      <div class="input-field">
        ...
        <label for="amount">{{ $filters.localize('Amount') }}</label>
          <span
            ...
            >{{ $filters.localize('Message_MinLength') }} {{v$.amount.minValue.$params.min}}</span>
      </div>
      ...
      <div class="input-field">
        ...
        <label for="description">{{ $filters.localize('Description') }}</label>
          <span
            ...
            >{{ $filters.localize('Message_EnterDescription') }}</span>
      </div>
